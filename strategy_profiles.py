...
PROFILE_BBWP_SQUEEZE = StrategyProfile(
    ...
    timeframes=("1h",),
    description=(
        "[BBWP Squeeze v9] Otimizacao de Saidas (entrada v8 mantida). "
        "v9: TP1=2.8x ATR (50%), trailing=1.7x, SL=2.2x, "
        "BBWP<15, buffer 5%, ADX>16, cooldown=2/1, max_bars=96, "
        "vol>0.35x, StochRSI 56/44. "
        "Pos-TP1 SL = TP1 - 0.5*ATR (floor 2.3*ATR no trailing). "
        "R:R floor: 1.16. Trailing racheta acima do floor. "
        "Custos: maker fee 0.016% + spread 2bps + slip 2bps."
    ),
